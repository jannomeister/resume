        ...
        <div>
          ...
          <ul class="bgrid-quarters s-bgrid-thirds cf">
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/git.png" alt="Git" />
              <h5>Git</h5>
            ...
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/angular.png" alt="Angular" />
              <h5>Angular</h5>
            ...
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/react.jpg" alt="ReactJS" />
              <h5>ReactJS</h5>
            ...
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/nativescript.png" alt="Nativescript" />
              <h5>Nativescript</h5>
            ...
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/nodejs.png" alt="NodeJS" />
              <h5>NodeJS</h5>
              <p style={{ overflowWrap: 'break-word' }}>This tech helps me to build server side application using it's awesome frameworks</p>
            </div>

            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/nodejs.png" alt="ExpressJS" />
              <h5>ExpressJS</h5>
            ...
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/nestjs.webp" alt="NestJS" />
              <h5>NestJS</h5>
            ...
            <div className="columns feature-item" style={{ textAlign: 'center', marginTop: '2.5em', paddingLeft: '2em', paddingRight: '2em' }}>
              <img class="skill" style={{ maxWidth: '65%' }} src="images/favorite_tech/bootstrap4.jpg" alt="Bootstrap 4" />
              <h5>Bootstrap 4</h5>
